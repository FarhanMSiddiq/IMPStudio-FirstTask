  ...
  public QuestionsDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfQuestions = new EntityInsertionAdapter<Questions>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `questions_table`(`id`,`question`,`answer`,`optA`,`optB`,`optC`,`optD`,`optE`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Questions value) {
        ...
        if (value.getOptD() == null) {
          ...
          stmt.bindString(7, value.getOptD());
        }
        if (value.getOptE() == null) {
          stmt.bindNull(8);
        } else {
          stmt.bindString(8, value.getOptE());
        }
      }
    };
    ...
    return new ComputableLiveData<List<Questions>>() {
      ...
      protected List<Questions> compute() {
        ...
        try {
          ...
          final int _cursorIndexOfOptD = _cursor.getColumnIndexOrThrow("optD");
          final int _cursorIndexOfOptE = _cursor.getColumnIndexOrThrow("optE");
          ...
          while(_cursor.moveToNext()) {
            ...
            _item.setOptD(_tmpOptD);
            final String _tmpOptE;
            _tmpOptE = _cursor.getString(_cursorIndexOfOptE);
            _item.setOptE(_tmpOptE);
            _result.add(_item);
          }
          return _result;
        } finally {
