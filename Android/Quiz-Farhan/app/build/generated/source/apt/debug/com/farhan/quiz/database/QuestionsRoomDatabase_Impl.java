  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `questions_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `question` TEXT NOT NULL, `answer` TEXT, `optA` TEXT, `optB` TEXT, `optC` TEXT, `optD` TEXT, `optE` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"6481fd7ff149832c47f5ff21516d89a8\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsQuestionsTable = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsQuestionsTable.put("optD", new TableInfo.Column("optD", "TEXT", false, 0));
        _columnsQuestionsTable.put("optE", new TableInfo.Column("optE", "TEXT", false, 0));
        ...
        if (! _infoQuestionsTable.equals(_existingQuestionsTable)) {
          throw new IllegalStateException("Migration didn't properly handle questions_table(com.farhan.quiz.database.Questions).\n"
                  + " Expected:\n" + _infoQuestionsTable + "\n"
                  + " Found:\n" + _existingQuestionsTable);
        }
      }
    }, "6481fd7ff149832c47f5ff21516d89a8");
